  ...
  return (
    <section id="inicio" className="relative min-h-[90vh] flex items-center pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-secondary/80 bg-gradient-to-r from-secondary/95 to-secondary/70 backdrop-blur-[2px]"></div>
      </div>
      ...
      <div className="container relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-sm font-medium animate-fade-in-up">
            ...
            <span>Especialistas em BPC (LOAS)</span>
          </div>
          ...
          >
            Seu BPC Aprovado —{' '}
            <span className="text-primary italic">Mesmo Que Tenha Sido Negado</span>
          </h1>
          ...
          >
            Garantimos seus direitos com um histórico comprovado de aprovações.
            <strong> E o melhor: você só paga os honorários se nós ganharmos a causa.</strong>
          </p>
          ...
          >
            ...
            <div className="text-sm text-white/70">
              <span className="text-white font-bold block">+500 famílias</span>
