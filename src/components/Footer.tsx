      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1 flex flex-col items-center md:items-start">
            ...
            />
            <p className="text-sm text-center md:text-left text-gray-300 font-medium">
          ...
          <div>
            <h3 className="text-white text-lg font-bold mb-6 uppercase tracking-wider">Contato</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Phone size={18} className="text-yellow-600 shrink-0 mt-1" />
                <div className="flex flex-col gap-1 text-gray-200 font-medium">
                  <a
                  ...
                  <a href="tel:+5553999998235" className="hover:text-yellow-500 transition-colors">
                    (53) 99999-8235
                  </a>
                </div>
              </li>
          ...
          <div>
            <h3 className="text-white text-lg font-bold mb-6 uppercase tracking-wider">Endereço</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-200 font-medium">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-400 font-medium flex flex-col md:flex-row justify-between items-center gap-4">
          <p>
